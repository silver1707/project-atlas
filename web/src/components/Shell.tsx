...
export function Shell({ active, onNavigate, isAuthenticated, children }: ShellProps) {
  return (
    <div className="app-shell">
      ...
      <main>
        <header className="topbar">
          ...
          <button className="icon-text-button" onClick={() => (isAuthenticated ? signOut() : signIn())} type="button">
